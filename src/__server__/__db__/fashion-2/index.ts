...
// get all contest carousel data
Mock.onGet("/api/fashion-shop-2/contest-carousel").reply(async () => {
  try {
    return [200, db.contestCarouselData];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
});
// get all banners oab2 data
Mock.onGet("/api/fashion-shop-2/oab2-banner").reply(async () => {
  try {
    return [200, db.bannerOAB2Data];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
});
// get all banners oab1 data
Mock.onGet("/api/fashion-shop-2/oab1-banner").reply(async () => {
  try {
    return [200, db.bannerOAB1Data];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
});
// get all banners postgraduate data
Mock.onGet("/api/fashion-shop-2/postagraduate-banner").reply(async () => {
  try {
    return [200, db.bannerPostGraduateData];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
});
// get all banners updatepractice data
Mock.onGet("/api/fashion-shop-2/updatepractice-banner").reply(async () => {
  try {
    return [200, db.bannerUpdatePracticeData];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
});
// get all banners firststeps data
Mock.onGet("/api/fashion-shop-2/firststeps-banner").reply(async () => {
  try {
    return [200, db.firstStepsData];
  } catch (err) {
    console.error(err);
    return [500, { message: "Internal server error" }];
  }
