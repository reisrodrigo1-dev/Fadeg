...
export const mainCarouselData = [
  {
    imgUrl:
      "https://www.meucurso.com.br/media/wysiwyg/BANNER_anula-wide.png",
    imgUrlMobile:
      "https://www.meucurso.com.br/media/wysiwyg/BANNER_anula-mob.png",
  },
  {
    imgUrl: "https://www.meucurso.com.br/media/wysiwyg/bnn-OAB-1F.jpg",
    imgUrlMobile:
      "https://www.meucurso.com.br/media/wysiwyg/bnn-OAB-1F-mob.jpg",
  },
];
// contest carousel data
export const contestCarouselData = [
  {
    BannerLargeURL:
...
export const categories = [
  {
    ...
    imageMobile: "/assets/images/capa_site_oab_mobile.png",
    slug: null,
    parent: [],
    description: null,
    for: {
  ...
  },
  {
    ...
    imageMobile: "/assets/images/capa_site_pos_mobile.png",
    slug: null,
    parent: [],
    description: null,
    for: {
  ...
  },
  {
    ...
    imageMobile: "/assets/images/capa_site_atualizacao_mobile.png",
    slug: null,
    parent: [],
    description: null,
    for: {
  ...
  },
  {
    ...
    imageMobile: "/assets/images/capa_site_concursos_mobile.png",
    slug: null,
    parent: [],
    description: null,
    for: {
...
export const serviceList = [
  ...
  },
  {
    ...
    icon: "Payment",
    title: "Pagamento",
    description: "Sistema seguro de pagamento",
  },
];
...
export const products = [
  {
    ...
    slug: "intensivo-oab-38",
    shop: {},
    title:
      "Intensivo OAB 38º Exame - Semanal Manhã - Início 13/03 - Presencial",
    shortDescription: "aulas presenciais a partir de 13/03/2023.",
    description: "aulas presenciais a partir de 13/03/2023.",
    brand: null,
    price: 1099,
    size: null,
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/Bipe/intensivo38.webp",
    images: ["/assets/images/Bipe/intensivo38.webp"],
    categories: ["1ª Fase OAB"],
    status: null,
    reviews: [],
    rating: 5,
    for: {
  ...
  },
  {
    ...
    slug: "pos-processo-civil",
    shop: {},
    title: "Pós-Graduação em Processo Civil",
    shortDescription:
      "A Pós-Graduação em Processo Civil visa atender a essa realidade em constante mudança do profissional.",
    description:
    ...
    colors: [],
    discount: 50,
    thumbnail: "/assets/images/Bipe/civil_fev_m.webp",
    images: [
      "/assets/images/Bipe/civil_fev_m.webp",
      "/assets/images/Bipe/civil_fev_m.webp",
    ],
  ...
  },
  {
    ...
    slug: "super-reta-final",
    shop: {},
    title: "Super Reta Final OAB 38º Exame - Semanal Online",
    shortDescription:
      "Online – noite – das 18h40 às 22h00 – após a transmissão ao vivo da aula, ela fica disponível para acesso a qualquer tempo.",
    description:
      "Online – noite – das 18h40 às 22h00 – após a transmissão ao vivo da aula, ela fica disponível para acesso a qualquer tempo.",
    brand: null,
    price: 799.99,
    ...
    colors: [],
    discount: 399.99,
    thumbnail: "/assets/images/Bipe/supereta.webp",
    images: [
      "/assets/images/Bipe/supereta.webp",
      "/assets/images/Bipe/supereta.webp",
    ],
    categories: ["1ª Fase OAB"],
    status: null,
  ...
  },
  {
    ...
    slug: "extensivo-oab-38-10-04",
    shop: {},
    title: "Extensivo OAB 38º - início 10/04",
    description:
      "Para aqueles que desejam aprofundar seus conhecimentos para o Exame de Ordem, desenvolvemos um programa com as 20 disciplinas da prova.",
    shortDescription:
      "Para aqueles que desejam aprofundar seus conhecimentos para o Exame de Ordem, desenvolvemos um programa com as 20 disciplinas da prova.",
    brand: null,
    price: 200,
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/Bipe/extensivo.webp",
    images: [
      "/assets/images/Bipe/extensivo.webp",
      "/assets/images/Bipe/extensivo.webp",
    ],
    categories: ["1ª Fase OAB"],
    status: null,
  ...
  },
  {
    ...
    title:
      "1a Fase OAB 38º Exame - Preparação turbinada 3 em 1: Intensivo + Resolução de Questões + Bônus das novas disciplinas",
    shortDescription:
      "Preparamos um curso COMBO com mais de 400 aulas com imersão nas 20 disciplinas do Exame de Ordem.",
    description:
      "Preparamos um curso COMBO com mais de 400 aulas com imersão nas 20 disciplinas do Exame de Ordem.",
    brand: null,
    price: 689.45,
    ...
    colors: [],
    discount: 0,
    thumbnail: "/assets/images/Bipe/oab_3_em_1_mini.webp",
    images: [
      "/assets/images/Bipe/oab_3_em_1_mini.webp",
      "/assets/images/Bipe/oab_3_em_1_mini.webp",
    ],
    categories: ["Fashion"],
    status: null,
