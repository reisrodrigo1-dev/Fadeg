...
const StyledDot = styled("div")<{
  ...
  dot_active?: any;
  fillInterval?: number;
}>(({ dot_color, dot_active, theme, fillInterval }) => ({
  width: 160,
  height: 5,
  margin: "0.25rem",
  cursor: "pointer",
  ...
  "&:after": {
    ...
    animation: dot_active ? "fillAnimation forwards" : "none",
    animationDuration: `${fillInterval}ms`,
    width: "0%",
    height: 5,
    top: "0%",
    left: "0%",
...
export const posCarouselStyle: CSSObject = {
  "& .carousel__back-button": {
