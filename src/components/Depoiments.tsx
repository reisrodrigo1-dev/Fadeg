...
const Depoiments = ({ titleColor }: DepoimentsProps) => {
  ...
  return (
    <Container sx={{ my: 3 }}>
      <H2 textAlign={"center"} color={titleColor}>
        Nossa missão é a aprovação dos nossos alunos...
      </H2>
      <Paragraph textAlign={"center"} color={titleColor} my={3}>
