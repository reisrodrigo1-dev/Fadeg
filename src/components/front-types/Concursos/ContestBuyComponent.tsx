...
const ContestBuyComponent = ({ singleProduct }) => {
  ...
  const hasUnselectedChildren = (product) => {
    return (product.Children || [])
      .map((child) => {
        return (
          !child.Selected ||
          (child.Children && hasUnselectedChildren(child))
        );
      })
      .includes(true);
  };
    ...
    <>
      ...
      >
        ...
        <Grid item md={4}>
          ...
          <span
            style={{ fontWeight: "400", fontSize: "16px", color: "#ffff" }}
          >
            no cartão de crédito
          </span>
        </Grid>
          ...
          {singleProduct.InStock &&
            hasUnselectedChildren(singleProduct) && (
              <BuyButton
                ...
                color="primary"
                sx={{ p: 2, minWidth: { xs: 0, md: "200px" } }}
              >
                Comprar
              </BuyButton>
            )}
          {((singleProduct.InStock &&
            hasSelectedChildren(singleProduct)) ||
...
export default ContestBuyComponent;
